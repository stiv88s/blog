define({ "api": [
  ...
  {
    "type": "get",
    "url": "https://api.admin-blog.test/api/v1/dislike/{model_id}",
    "title": "Dislike Entity",
    "group": "Dislike",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "model_type",
            "description": "<p>post or comment</p>"
          }
        ]
      }
    },
    ...
    "version": "0.0.0",
    "filename": "app/Http/Controllers/Api/DislikeController.php",
    "groupTitle": "Dislike",
    "name": "GetHttpsApiAdminBlogTestApiV1DislikeModel_id",
    "header": {
      "examples": [
        {
  ...
  {
    "type": "get",
    "url": "https://api.admin-blog.test/api/v1/like/{model_id}",
    "title": "Like Entity",
    "group": "Like",
    "parameter": {
      "fields": {
    ...
    "version": "0.0.0",
    "filename": "app/Http/Controllers/Api/LikeController.php",
    "groupTitle": "Like",
    "name": "GetHttpsApiAdminBlogTestApiV1LikeModel_id",
    "header": {
      "examples": [
        {
          "title": "Header-Example:",
